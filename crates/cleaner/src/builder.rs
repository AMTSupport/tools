...
// use tracing::trace;
// use std::{paths::PathBuf, slice::Iter};
//
// #[derive(Debug, Clone)]
// pub enum AgeType {
//     FromCreation,
...
//     fn env(env: &str) -> Self;
//     fn paths(self, composing: &str) -> Self;
//     fn auto(self) -> Self;
...
//     }
//
//     fn paths(mut self, composing: &str) -> Self {
...
//
//     fn build(&self) -> anyhow::Result<CleanablePath> {
//         let buf = PathBuf::from(self.composing.clone().context("Unwrap paths")?);
...
//         return Err(anyhow!("Env variable {} does not exist as paths", variable));
//     }
//
